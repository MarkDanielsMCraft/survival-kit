  ...
  return (
    <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="font-semibold text-slate-900 text-sm uppercase tracking-wide">Read more (Verified sources)</h3>
      </div>
      ...
      <div className="space-y-3">
        {links.map((l, idx) => (
          <a
            ...
            className="w-full text-left bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-2xl px-4 py-3 transition flex items-center justify-between"
          >
